...
rule all:
    input:
        "results/af_tables/nominal_kgpex.eqtl.tsv",
        "results/af_tables/finemapped_kgpex.eqtl.tsv",
        "results/af_tables/finemapped_single_kgpex.sqtl.tsv",
        "results/af_tables/finemapped_single_kgpex.eqtl.tsv",
...
rule filter_finemapping_cred_sets:
    ...
    run:
        ...
        tot_df = df.groupby(['geneID', 'variantCredibleSet'])[['variantPIP','variantID']].agg(np.max).reset_index()[['geneID', 'variantID']]
...
rule assign_allele_freq_nominal:
    ...
    output:
        snplist = temp("variants.nominal.kgpex_eqtl.txt"),
        af_tsv = "results/af_tables/nominal_kgpex.eqtl.tsv",
    shell:
        """
...
rule assign_allele_freq_finemapped_total:
    ...
    input:
        ...
        finemapped_eqtls= finemapped_eqtls
    output:
        snplist = temp("variants.finemapped.kgpex_eqtl.txt"),
        af_tsv = "results/af_tables/finemapped_kgpex.eqtl.tsv",
    shell:
        """
...
rule assign_allele_freq_finemapped_single_total:
    ...
    output:
        snplist = temp("variants.finemapped.single.kgpex_eqtl.txt"),
        af_tsv = "results/af_tables/finemapped_single_kgpex.eqtl.tsv",
    shell:
        """
...
rule assign_allele_freq_top_sqtl:
    ...
    output:
        snplist = temp("variants.finemapped.single.kgpex_sqtl.txt"),
        af_tsv = "results/af_tables/finemapped_single_kgpex.sqtl.tsv"
    shell:
        """
...
rule isolate_kgpex_dapg_replicates:
    ...
    input:
        vcf_file = vcf_file,
        non_replicates = "results_forDylan/kgpex_dapg_metaCS_nonreplicates_nonzeroPIP.top_eVariants.090123.tsv",
        replicates = "results_forDylan/kgpex_dapg_metaCS_replicates_nonzeroPIP.top_eVariants.090123.tsv"
    output:
        snplist_replicates = "results/variant_lists/kgpex_dapg_metaCS_replicates_snplist.txt",
        snplist_nonreplicates = "results/variant_lists/kgpex_dapg_metaCS_nonreplicates_snplist.txt",
        af_replicates_tsv = "results/af_tables/kgpex_dapg_metaCS_replicates.top_eVariants.tsv",
        af_nonreplicates_tsv = "results/af_tables/kgpex_dapg_metaCS_nonreplicates.top_eVariants.tsv"
    shell:
        """
