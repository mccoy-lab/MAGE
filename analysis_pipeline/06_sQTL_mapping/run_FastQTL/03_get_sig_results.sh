...
phenGroupsFile=$3
out_sGeneListFile=$4 # Output file containing significant sGenes
out_sigNominalResultsFile=$5 # Output file contains significant nominal associations
...
$getSigResultsScript --nominalResults $nominalResultsFile \
					 ...
					 --phenGroups $phenGroupsFile \
					 --out_sGene $out_sGeneListFile \
